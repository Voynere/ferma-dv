...
<div class="wrapper">
    ...
    <div class="container"><div class="woocommerce-breadcrumbs shop-ferma__breadcrumbs"><?php woocommerce_breadcrumb(); ?></div></div>
    ...
    echo '<div class="container list_subcat_menu shop-ferma__archive-subcat">';
    if( $par_cat ){ ?>
        <a href="<?php echo get_term_link( $par_cat, 'product_cat' )?> <?
        $cur_user_id = get_current_user_id();
        $user_info = get_userdata($cur_user_id);
        if($args_check == "ГринМаркет ТЦ Море") { echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356"; }
        if($args_check == "Жигура") { echo "?wms-addon-store-filter-form%5B0%5D=8cc659e5-4bfb-11ec-0a80-075000080e54"; }
        if($args_check == "Реми-Сити") { echo "?wms-addon-store-filter-form%5B0%5D=b24e4c35-9609-11eb-0a80-0d0d008550c2"; }
        if($args_check == "Эгершельд") { echo "?wms-addon-store-filter-form%5B0%5D=7c0dc9ce-ce1e-11ea-0a80-09ca000e5e93"; }
        if($args_check == "Космос") { echo "?wms-addon-store-filter-form%5B0%5D=a99d6fdf-0970-11ed-0a80-0ed600075845"; }
        if($args_check == "Уссурийск") { echo "?wms-addon-store-filter-form%5B0%5D=9c9dfcc4-733f-11ec-0a80-0da1013a560d"; }
        ?>" class="url_upimg"><img style="width: 16px;" src="/wp-content/themes/theme/img/up_img.png"></a>
    <?}
    if( $subcats_list ){
